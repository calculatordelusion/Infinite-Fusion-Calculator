    ...
    <Card className="space-y-4 grid-lines bg-slate-50 dark:bg-slate-900 p-1 md:p-4">
      <CardHeader className="p-1 px-2 text-center">
        ...
        <CardDescription className="mx-auto max-w-screen-xl text-muted-foreground text-sm">
          The most advanced Pokémon fusion generator online. Combine any two of {gameInfo.totalBasePokemon} base Pokémon to create {gameInfo.totalFusions.toLocaleString()} possible fusion combinations with custom sprites, stats, and abilities.
        </CardDescription>
      </CardHeader>
          ...
          <Table>
            ...
            <TableBody>
              ...
              <TableRow>
                ...
                <TableCell className="text-right">251,001</TableCell>
              </TableRow>
              <TableRow>
                <TableCell>Fusions with Custom Artwork</TableCell>
                <TableCell className="text-right">130,816</TableCell>
              </TableRow>
              <TableRow>
                <TableCell>Total Custom Sprites</TableCell>
                <TableCell className="text-right">180,662</TableCell>
              </TableRow>
              <TableRow>
